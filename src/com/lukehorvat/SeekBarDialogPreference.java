...
import com.secaucus.Shuffly.R;

/**
 * A {@link android.preference.DialogPreference} that provides a user with the means to select an integer from a {@link android.widget.SeekBar}, and persist it.
 * 
 * @author lukehorvat
 * 
 */
